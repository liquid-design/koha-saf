"""
DNB SRU bron - Deutsche Nationalbibliothek.

Endpoint:  https://services.dnb.de/sru/dnb
Query:     dnb.num=<ISBN>
Schema:    MARC21-xml

Onverwacht waardevol voor SAF: dekt internationale uitgaven van
Duitstalige auteurs (Rosa Luxemburg, Marx, etc) waar andere bronnen
misses op geven. Zie doc 24.
"""
